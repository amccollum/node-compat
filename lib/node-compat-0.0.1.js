(function() {
  var assert, deepEqual, equal, events, expectedException, fail, isArguments, isArray, notDeepEqual, notEqual, notStrictEqual, objEquiv, ok, process, streams, strictEqual, _deepEqual, _nextTickCallback, _nextTickQueue, _ref, _throws;
